...
public class AstralFireRuneItem extends Item {
	public AstralFireRuneItem() {
		super(new Item.Properties().tab(ElementsOfTantalusModTabs.TAB_RUNES).stacksTo(64).rarity(Rarity.COMMON));
		setRegistryName("astral_fire_rune");
	}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A perfect rune bearing the symbol for Fire"));
	}
}
