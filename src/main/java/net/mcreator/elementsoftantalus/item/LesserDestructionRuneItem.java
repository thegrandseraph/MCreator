...
public class LesserDestructionRuneItem extends Item {
	public LesserDestructionRuneItem() {
		super(new Item.Properties().tab(ElementsOfTantalusModTabs.TAB_RUNES).stacksTo(1).rarity(Rarity.COMMON));
		setRegistryName("lesser_destruction_rune");
	}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A weak rune bearing the symbol for Destruction"));
	}
}
