...
import net.mcreator.elementsoftantalus.procedures.Astral1Procedure;
import net.mcreator.elementsoftantalus.network.Inscriber4SlotMessage;
...
public class Inscriber4Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public Inscriber4Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ElementsOfTantalusModMenus.INSCRIBER_4, id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 16, 35) {
			...
			public boolean mayPlace(ItemStack stack) {
				return (ElementsOfTantalusModItems.ASTRAL_ETCHER == stack.getItem());
			}
		}));
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 142, 35) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return (ElementsOfTantalusModItems.ASTRAL_TABLET == stack.getItem());
			}
		}));
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			ElementsOfTantalusMod.PACKET_HANDLER.sendToServer(new Inscriber4SlotMessage(slotid, x, y, z, ctype, meta));
			Inscriber4SlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof Inscriber4Menu) {
			Level world = entity.level;
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();

			Astral1Procedure.execute(entity);
		}
	}
}
