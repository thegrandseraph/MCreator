...
public class InscriptionGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public InscriptionGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ElementsOfTantalusModMenus.INSCRIPTION_GUI, id);
		...
		this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 88, 26) {
			@Override
