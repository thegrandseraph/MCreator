...
public class Inscriber2GuiScreen extends AbstractContainerScreen<Inscriber2GuiMenu> {
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public Inscriber2GuiScreen(Inscriber2GuiMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("elements_of_tantalus:textures/inscriber_2_gui.png");
